// ... imports
// (Note: I will provide the full file content for clarity and safety)
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <header className="mb-12">
                    ...
                    <p className="text-xl text-slate-400 max-w-2xl">
                        Danh sách chính thức 34 tỉnh/thành phố và 3.321 xã phường theo cấu trúc địa giới hành chính mới.
                    </p>
                </header>
                    ...
                    <div className="lg:col-span-1 lg:sticky lg:top-24">
                        {selectedProvince ? (
                            <div className="bg-slate-900/80 border border-white/10 rounded-2xl p-6 backdrop-blur-xl shadow-2xl relative overflow-hidden">
                                ...
                                <div className="flex justify-between items-center mb-6">
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-400">Tìm thấy {selectedCommunesData?.phuongxa.length || 0} xã/phường</p>
                                    </div>
                                    <button
                                ...
                                <div className="space-y-2 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                                    {filteredCommunes?.length === 0 ? (
                                        <div className="text-center py-8 text-slate-500 text-sm">
                                            Không tìm thấy xã nào khớp với "{searchQuery}"
                                        </div>
                                    ) : (
                            ...
                            <div className="hidden lg:flex flex-col items-center justify-center h-64 border-2 border-dashed border-white/10 rounded-2xl bg-white/5 text-slate-500 p-6 text-center">
                                ...
                                <p>Chọn một tỉnh từ danh sách để xem chi tiết.</p>
                            </div>
                        )}
                    </div>
                </div>
